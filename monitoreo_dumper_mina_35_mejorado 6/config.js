...
// CONFIGURACION FIREBASE PARA SINCRONIZACION MULTIDISPOSITIVO
// 1) Crea un proyecto en Firebase Console.
// 2) Crea una Web App.
// 3) Activa Realtime Database.
// 4) Reemplaza estos valores por los datos reales de firebaseConfig.
//
// Mientras estos valores sigan con "TU_...", el sistema funciona en modo local
// y no intenta escribir en Firebase.
...
window.FIREBASE_SYNC_CONFIG = {
  enabled: true,
  basePath: "monitoreoDumper",
  currentPath: "datosActuales",
  historyPath: "historial",
  publishEveryMs: 1000,
  historyEveryMs: 5000
};
